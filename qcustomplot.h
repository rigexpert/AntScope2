...
public:
  ...
  */
  ...
  double getRangeLower(void);
  double getRangeUpper(void);
...
public:
  ...
  */
  ...
  void setData(const QVector<double> &key, const QVector<double> &value, int lenght);
  void getData();
...
class QCP_LIB_DECL QCPItemTriangle : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
  ...
  /// \endcond
public:
  QCPItemTriangle(QCustomPlot *parentPlot);
  virtual ~QCPItemTriangle();
